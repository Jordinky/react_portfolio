    ...
    sx={{
      ...
      <ul class="example-2">
            <li class="icon-content">
              <a
                href="https://www.linkedin.com/in/jordipelaez/"
                aria-label="LinkedIn"
            ...
            <li class="icon-content">
              <a href="https://github.com/Jordinky" aria-label="GitHub" data-social="github">
                <div class="filled"></div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
            ...
            <li class="icon-content">
              <a
                href="https://www.instagram.com/guacamole_lover/"
